...
Lastly, all variants of *FFNN_..._testing.ipynb* jupyter nodebooks contain our testing and use of the previously mentioned implementations. Separate notebooks are found for general FFNN testing, regression problem testing and classification testing.